...
const reviewData = allRatings.find(r => r.idMeal === meal.idMeal);
...
// ✅ Lägg till detta – visa alla recensioner (om de finns)
if (reviewData && Array.isArray(reviewData.reviews)) {
  displayReviews(container, reviewData.reviews, "meal");
} else {
  displayReviews(container, [], "meal"); // Tom lista = visar "No reviews yet"
}
